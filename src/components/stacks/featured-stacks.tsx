      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-destructive">
            Failed to load featured stacks. Please try again later.
          </div>
        </div>
      </section>
    )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
            Discover the most popular and highly-rated tech stacks with their specialized AI agents.
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                {stacksResponse.count > 6 
                  ? `Showing 6 of ${stacksResponse.count} available stacks`
                  : `${stacksResponse.count} stacks available`
                }
              </p>
            </div>
          </>
